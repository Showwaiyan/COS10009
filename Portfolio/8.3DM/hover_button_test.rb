...
class DemoWindow < Gosu::Window
  ...
  def draw()
    ...
    @info_font.draw("mouse_y: #{mouse_y}", @info_font.text_width("mouse_y: #{mouse_y}")+20, 350, ZOrder::TOP, 1.0, 1.0, Gosu::Color::BLACK)
    # Draw black border around button if mouse is over it
    draw_border(mouse_x, mouse_y)
  end
 ...
 # This still needs to be fixed!
  ...
  def draw_border(mouse_x, mouse_y)
    if mouse_over_button(mouse_x, mouse_y)
      Gosu.draw_line(50, 50, Gosu::Color::BLACK, 150, 50, Gosu::Color::BLACK, ZOrder::MIDDLE, mode=:default)
      Gosu.draw_line(150, 50, Gosu::Color::BLACK, 150, 100, Gosu::Color::BLACK, ZOrder::MIDDLE, mode=:default)
      Gosu.draw_line(50, 100, Gosu::Color::BLACK, 150, 100, Gosu::Color::BLACK, ZOrder::MIDDLE, mode=:default)
      Gosu.draw_line(50, 50, Gosu::Color::BLACK, 50, 100, Gosu::Color::BLACK, ZOrder::MIDDLE, mode=:default)
    end
  end
